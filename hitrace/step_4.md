...
[![annotate_sequence Figure empty](/hitrace/res/pfl_1D_xsel_empty.png "annotate_sequence Figure (empty)"){: style="width:90%;"}](/hitrace/res/pfl_1D_xsel_empty.png)
...
[![annotate_sequence Figure 2 bands](/hitrace/res/pfl_1D_xsel_2band.png "annotate_sequence Figure (2 bands)"){: style="width:90%;"}](/hitrace/res/pfl_1D_xsel_2band.png)

Once it finishes the calculation, you will see sequence positions filled out for you:

[![annotate_sequence Figure Auto-assign](/hitrace/res/pfl_1D_xsel_auto.png "annotate_sequence Figure (Auto-assign)"){: style="width:90%;"}](/hitrace/res/pfl_1D_xsel_auto.png)
...
[![annotate_sequence Missing 1 Band](/hitrace/res/pfl_1D_xsel_miss.png "annotate_sequence Missing 1 Band")](/hitrace/res/pfl_1D_xsel_miss.png)
[![annotate_sequence Having 1 Extra Band](/hitrace/res/pfl_1D_xsel_extra.png "annotate_sequence Having 1 Extra Band")](/hitrace/res/pfl_1D_xsel_extra.png)
