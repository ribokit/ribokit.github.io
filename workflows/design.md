...
1. **Design tertiary structure**. Do you already have a junction or tertiary contact structure that you want to stabilize?  
 + __Yes__ for 
 + __No__ your RNA tether in [RNAMake](RNAmake/). The sequences of the internal junctions and tertiary contacts will be defined by the motifs, but the helices will be arbitrary. If you want to just find alternative
2. **Design secondary structure**  to optimize the sequences of the helices.  Use the [EternaBot server](http://eternabot.cmu.edu/) or its implementation within [RNAMake](RNAmake/)
